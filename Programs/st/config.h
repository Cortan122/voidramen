...
const int upperScrollingLimit = 1;
const int lowerScrollingLimit = 0;
const int stickyScrolling = 1;
...
static MouseShortcut mshortcuts[] = {
  /* button               mask            string */
  { Button4,              XK_NO_MOD,      "\033OA\033OA\033OA" },
  { Button5,              XK_NO_MOD,      "\033OB\033OB\033OB" },
};
...
static char *themeCommand[] = { "/bin/sh", "-c",
  "\""__DIR__"/themes.sh\" < /dev/null",
  "externalpipe", NULL };
...
MouseKey mkeys[] = {
  ...
  { Button4,              TERMMOD,        incrementAlpha, {.f = .1} },
  { Button5,              TERMMOD,        incrementAlpha, {.f =-.1} },
  { Button2,              TERMMOD,        incrementAlpha, {.i =  0} },
...
static Shortcut shortcuts[] = {
  ...
  { TERMMOD,              XK_T,           externalpipe,   {.v = themeCommand} },
};
...
static Key key[] = {
  ...
  { XK_BackSpace,    ControlMask,                    "\x08",        0,  0},
